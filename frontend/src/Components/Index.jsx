            ...
            <div className="modal-content">
                <div className="modal-body">
                    <div className="header-top-action-dropdown">
                        <ul>
                            <li className="signin-option"><a onClick="OpenSignUpForm()" href="#" data-dismiss="modal"><i className="fas fa-user mr-2"></i>Sign In</a></li>
            ...
            <div className="d-none d-xl-flex row align-items-center">
                ...
                <div className="col-2 col-md-1 col-lg-5">
                    <ul className="site-action d-none d-lg-flex align-items-center justify-content-between  ml-auto">
                        ...
                        <li className="signin-option"><a onClick="OpenSignUpForm()" href="#"><i className="fas fa-user mr-2"></i>Sign In</a></li>
                    </ul>
                </div>
                            ...
                            <div className="swiper-wrapper">
                                ...
                                <div className="swiper-slide">
                                    <a href="product-list.html" className="catagory-item">
                                        ...
                                        <p className="catagory-name">Health Products</p>
                                    </a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                        <div className="product-item">
                                            ...
                                            <div className="product-content">
                                                ...
                                                <h6><a href="product-detail.html" className="product-title">Green Graves</a></h6>
                                                <p className="quantity">1 kg</p>
                                                <div className="d-flex justify-content-between align-items-center">
                                                    <div className="price">$8.00 <del>$10.00</del></div>

                                                    <div className="cart-btn-toggle" onClick="cartopen()">
                                    ...
                                    <div className="swiper-slide">
                                        <div className="product-item stock-out">
                                            ...
                                            <div className="product-content">
                                                <a href="#" className="cata">Catagory</a>
                                                <h6><a href="product-detail.html" className="product-title">Kiwi</a></h6>
                                                <p className="quantity">1 kg</p>
                                                <div className="d-flex justify-content-between align-items-center">
                                                    <div className="price">$8.00 <del>$10.00</del></div>
                                                    <div className="cart-btn-toggle" onClick="cartopen()">
                                    ...
                                    <div className="swiper-slide">
                                        <div className="product-item">
                                            ...
                                            <div className="product-content">
                                                <a href="#" className="cata">Catagory</a>
                                                <h6><a href="product-detail.html" className="product-title">Tomato</a></h6>
                                                <p className="quantity">1 kg</p>
                                                <div className="d-flex justify-content-between align-items-center">
                                                    <div className="price">$8.00 <del>$10.00</del></div>
                                                    <div className="cart-btn-toggle" onClick="cartopen()">
                                    ...
                                    <div className="swiper-slide">
                                        <div className="product-item">
                                            ...
                                            <div className="product-content">
                                                <a href="#" className="cata">Catagory</a>
                                                <h6><a href="product-detail.html" className="product-title">Corn on the Cob</a></h6>
                                                <p className="quantity">1 kg</p>
                                                <div className="d-flex justify-content-between align-items-center">
                                                    <div className="price">$8.00 <del>$10.00</del></div>
                                                    <div className="cart-btn-toggle" onClick="cartopen()">
                                    ...
                                    <div className="swiper-slide">
                                        <div className="product-item">
                                            ...
                                            <div className="product-content">
                                                <a href="#" className="cata">Catagory</a>
                                                <h6><a href="product-detail.html" className="product-title">Raddish Vegitable</a></h6>
                                                <p className="quantity">1 kg</p>
                                                <div className="d-flex justify-content-between align-items-center">
                                                    <div className="price">$8.00 <del>$10.00</del></div>
                                                    <div className="cart-btn-toggle" onClick="cartopen()">
                                ...
                                <div className="swiper-wrapper">
                                    ...
                                    <div className="swiper-slide">
                                        <div className="product-item">
                                            ...
                                            <div className="product-content">
                                                <a href="#" className="cata">Catagory</a>
                                                <h6><a href="product-detail.html" className="product-title">Carrot</a></h6>
                                                <p className="quantity">1 kg</p>
                                                <div className="d-flex justify-content-between align-items-center">
                                                    <div className="price">$8.00 <del>$10.00</del></div>
                                                    <div className="cart-btn-toggle" onClick="cartopen()">
                                    ...
                                    <div className="swiper-slide">
                                        <div className="product-item">
                                            ...
                                            <div className="product-content">
                                                <a href="#" className="cata">Catagory</a>
                                                <h6><a href="product-detail.html" className="product-title">Apple</a></h6>
                                                <p className="quantity">1 kg</p>
                                                <div className="d-flex justify-content-between align-items-center">
                                                    <div className="price">$8.00 <del>$10.00</del></div>
                                                    <div className="cart-btn-toggle" onClick="cartopen()">
                    ...
                    <div className="section-wrapper">
                        ...
                        <div className="testimonial-slider-btn-group">
                            <div className="testimonial-slider-prev">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512.008 512.008" style={{enableBackground: "new 0 0 512.008 512.008"}} xmlSpace="preserve"><path style={{fill: "#2196F3"}} d="M501.342,245.185H36.424L210.227,71.404c4.093-4.237,3.975-10.99-0.262-15.083 c-4.134-3.992-10.687-3.992-14.82,0l-192,192c-4.171,4.16-4.179,10.914-0.019,15.085c0.006,0.006,0.013,0.013,0.019,0.019l192,192 c4.093,4.237,10.845,4.354,15.083,0.262c4.237-4.093,4.354-10.845,0.262-15.083c-0.086-0.089-0.173-0.176-0.262-0.262 L36.424,266.519h464.917c5.891,0,10.667-4.776,10.667-10.667S507.233,245.185,501.342,245.185z"></path><path d="M202.675,458.519c-2.831,0.005-5.548-1.115-7.552-3.115l-192-192c-4.164-4.165-4.164-10.917,0-15.083l192-192 c4.237-4.093,10.99-3.975,15.083,0.262c3.992,4.134,3.992,10.687,0,14.82L25.758,255.852L210.206,440.3 c4.171,4.16,4.179,10.914,0.019,15.085C208.224,457.39,205.508,458.518,202.675,458.519z"></path><path d="M501.342,266.519H10.675c-5.891,0-10.667-4.776-10.667-10.667s4.776-10.667,10.667-10.667h490.667 c5.891,0,10.667,4.776,10.667,10.667S507.233,266.519,501.342,266.519z"></path></svg>
                            </div>
