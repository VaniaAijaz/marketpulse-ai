                            ...
                            <div className="row product-list">
                                <div className="col-sm-6 col-lg-4 col-xl-3">
                                    <div className="product-item">
                                        ...
                                        <div className="product-content">
                                            ...
                                            <h6><a href="product-detail.html" className="product-title">Vegitable Leaf</a></h6>
                                ...
                                <div className="col-sm-6 col-lg-4 col-xl-3">
                                    <div className="product-item">
                                        ...
                                        <div className="product-content">
                                            <a href="#" className="cata">Catagory</a>
                                            <h6><a href="product-detail.html" className="product-title">Green Grave</a></h6>
                                            <p className="quantity">1 kg</p>
                                            <div className="d-flex justify-content-between align-items-center">
                                                <div className="price">$85.00 <del>$100.00</del></div>
                                ...
                                <div className="col-sm-6 col-lg-4 col-xl-3">
                                    <div className="product-item">
                                        ...
                                        <div className="product-content">
                                            <a href="#" className="cata">Catagory</a>
                                            <h6><a href="product-detail.html" className="product-title">Red Tomato</a></h6>
                                            <p className="quantity">1 kg</p>
                                            <div className="d-flex justify-content-between align-items-center">
                                                <div className="price">$85.00 <del>$100.00</del></div>
                                ...
                                <div className="col-sm-6 col-lg-4 col-xl-3">
                                    <div className="product-item">
                                        ...
                                        <div className="product-content">
                                            <a href="#" className="cata">Catagory</a>
                                            <h6><a href="product-detail.html" className="product-title">Radish Vegitable</a></h6>
                                            <p className="quantity">1 kg</p>
                                            <div className="d-flex justify-content-between align-items-center">
                                                <div className="price">$85.00 <del>$100.00</del></div>
                                ...
                                <div className="col-sm-6 col-lg-4 col-xl-3">
                                    <div className="product-item">
                                        ...
                                        <div className="product-content">
                                            <a href="#" className="cata">Catagory</a>
                                            <h6><a href="product-detail.html" className="product-title">Healthy Carrots</a></h6>
                                            <p className="quantity">1 kg</p>
                                            <div className="d-flex justify-content-between align-items-center">
                                                <div className="price">$85.00 <del>$100.00</del></div>
